  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active" aria-current="page" href="/user-login-system">Home</a>
...
<div class="container">
    ...
    if(isset($_POST['submit'])){
        ...
        if($phoneUtil->isValidNumber($parseNumber)){
            setFlashData("Number is valid");
        }
        else{
            setFlashData("Number is not valid");
        }
        exit;
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card" style="margin-top: 30px">
                ...
                <div class="card-body">
                        <form id="form" autocomplete="off" action="<?=base_url('/register')?>"  method="post">
                            <div class="mb-3">
                            ...
                            <div class="text-center">
                                <a type="submit" href="/user-login-system">Already Have An Account</a>
                            </div>
